...
import {addCloud, moveCloud, moveLeft, moveRight, removeCloud, collision} from "../features/cloud/cloudSlice.js";
                ...
                >
                    ...
                    <span className={"border-2 border-red-500"}
                        style={{
                            ...
                            color: "black",
                            fontWeight: "bold",
                            fontSize: `${(gameRef.current?.offsetWidth || 1280) / 1280 * 22}px`,
                            pointerEvents: "none",
                        }}
                    >
                        {cloud.word}
